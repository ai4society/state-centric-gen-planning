(define (problem grid-1-11-start-0-10)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x0-y1 loc-x0-y2 loc-x0-y3 loc-x0-y4 loc-x0-y5 loc-x0-y6 loc-x0-y7 loc-x0-y8 loc-x0-y9 loc-x0-y10)
  (:init
    (at-robot loc-x0-y10)
    (visited loc-x0-y10)
