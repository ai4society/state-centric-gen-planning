(define (problem grid-4-4-start-2-1)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x1-y0 loc-x2-y0 loc-x3-y0 loc-x0-y1 loc-x1-y1 loc-x2-y1 loc-x3-y1 loc-x0-y2 loc-x1-y2 loc-x2-y2 loc-x3-y2 loc-x0-y3 loc-x1-y3 loc-x2-y3 loc-x3-y3)
  (:init
    (at-robot loc-x2-y1)
    (visited loc-x2-y1)
