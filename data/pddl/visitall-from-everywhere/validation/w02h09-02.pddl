(define (problem grid-2-9-start-1-0)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x1-y0 loc-x0-y1 loc-x1-y1 loc-x0-y2 loc-x1-y2 loc-x0-y3 loc-x1-y3 loc-x0-y4 loc-x1-y4 loc-x0-y5 loc-x1-y5 loc-x0-y6 loc-x1-y6 loc-x0-y7 loc-x1-y7 loc-x0-y8 loc-x1-y8)
  (:init
    (at-robot loc-x1-y0)
    (visited loc-x1-y0)
