(define (problem grid-7-2-start-3-0)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x1-y0 loc-x2-y0 loc-x3-y0 loc-x4-y0 loc-x5-y0 loc-x6-y0 loc-x0-y1 loc-x1-y1 loc-x2-y1 loc-x3-y1 loc-x4-y1 loc-x5-y1 loc-x6-y1)
  (:init
    (at-robot loc-x3-y0)
    (visited loc-x3-y0)
