(define (problem grid-11-1-start-10-0)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x1-y0 loc-x2-y0 loc-x3-y0 loc-x4-y0 loc-x5-y0 loc-x6-y0 loc-x7-y0 loc-x8-y0 loc-x9-y0 loc-x10-y0)
  (:init
    (at-robot loc-x10-y0)
    (visited loc-x10-y0)
