(define (problem grid-2-8-start-0-4)
  (:domain grid-visit-all)
  (:objects loc-x0-y0 loc-x1-y0 loc-x0-y1 loc-x1-y1 loc-x0-y2 loc-x1-y2 loc-x0-y3 loc-x1-y3 loc-x0-y4 loc-x1-y4 loc-x0-y5 loc-x1-y5 loc-x0-y6 loc-x1-y6 loc-x0-y7 loc-x1-y7)
  (:init
    (at-robot loc-x0-y4)
    (visited loc-x0-y4)
